...
void CreateWindow(void)
{
	...
	XStoreName ( gpDisplay, gWindow,"Darshan's : Stone Texture XWindows");
...
void Render(void)
{
	...
	/* 	SOIL Inverts the Image Data as comapare to windows LoadImage() 
		i.e. such that it's origin is ___Left Top___which
	 is Exactaly oposite to OpenGL origin ___left Bottom____
*/
