...
/* Lighting variables */
bool gbLight = true;
GLfloat lAmbient[] = { 0.5f, 0.5f, 0.5f, 0.0f };
GLfloat lDefues[] = { 1.0f, 1.0f, 1.0f, 0.0f };
GLfloat lPosition[] = { 0.0f, 0.0f, 10.0f, 1.0f };
...
void CreateWindow(void)
{
	...
	XStoreName ( gpDisplay, gWindow,"Darshan's : Cube With Single Light XWindows");
