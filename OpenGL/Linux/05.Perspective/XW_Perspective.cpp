...
void CreateWindow(void)
{
	...
	static int frameBufferAttributes[] = { GLX_RGBA, 
						...
						GLX_BLUE_SIZE, 1,
						GLX_ALPHA_SIZE, 1,
						/* LAST PARAMETER COULD BE Null or 0 (Here we are indicating that we don't want more space and componants you can 							take default)*/
						None};
	...
	XStoreName ( gpDisplay, gWindow,"Darshan's : Perspective XWindows");
