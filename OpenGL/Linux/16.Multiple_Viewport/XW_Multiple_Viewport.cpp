...
Colormap gColormap;
Window gWindow;
XWindowAttributes *gXWindowsAttribute = NULL;
		...
		while(XPending(gpDisplay))
		{
			...
			switch(event.type)
			{
				...
				switch(keysym)
				{
					...
					/*if(XGetWindowAttributes(gpDisplay, gWindow, gXWindowsAttribute))
					{
						printf("gXWindowsAttribute is NULL.\n");
						uninitialize();
						exit(0);
					}
					else
					{
						printf("gXWindowsAttribute is not NULL.\n");
					}*/
					...
					break;
					case XK_5:
						glViewport(0, 0, (GLsizei)winWidth / 2, winHeight);
					break;
					case XK_6:
						glViewport((GLsizei)winWidth / 2, 0, (GLsizei)winWidth / 2, winHeight);
					break;
					case XK_7:
						glViewport(0, (GLsizei)winHeight / 2, winWidth, (GLsizei)winHeight / 2);
					break;
					case XK_8:
						glViewport(0, 0, winWidth, (GLsizei)winHeight / 2);
					break;
					case XK_9:
...
void CreateWindow(void)
{
	...
	XStoreName ( gpDisplay, gWindow,"Darshan's: Mutiple Viewport XWindows");
...
void uninitialize(void)
{
	...
	if(gXWindowsAttribute != NULL)
	{
		gXWindowsAttribute = NULL;
	}
