...
/*splite 1.model view, 2.projection matrics */
    ...
    -(void) prepareOpenGL
    {
        ...
        glBufferData(GL_ARRAY_BUFFER, sizeof(CubeVertices_PV), CubeVertices_PV, GL_STATIC_DRAW);
        ...
        glBufferData(GL_ARRAY_BUFFER, sizeof(CubeNormals_PV), CubeNormals_PV, GL_STATIC_DRAW);
