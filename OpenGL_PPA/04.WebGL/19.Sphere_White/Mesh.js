...
function Mesh()
{
    ...
    this.prepareToDraw=function()
    {
        ...
        gl.vertexAttribPointer(WebGLMacros.DVM_ATRIBUTE_VERTEX,
                               3,
                               gl.FLOAT,
                               false,0,0);
        gl.enableVertexAttribArray(WebGLMacros.DVM_ATRIBUTE_VERTEX);
        ...
        gl.bufferData(gl.ARRAY_BUFFER,
                      norms,
                      gl.STATIC_DRAW);
        gl.vertexAttribPointer(WebGLMacros.DVM_ATRIBUTE_NORMALS,
                               3,
                               gl.FLOAT,
                               false,0,0);
        gl.enableVertexAttribArray(WebGLMacros.DVM_ATRIBUTE_NORMALS);
        gl.bindBuffer(gl.ARRAY_BUFFER,null);
        ...
        gl.bufferData(gl.ARRAY_BUFFER,
                      texCoords,
                      gl.STATIC_DRAW);
        gl.vertexAttribPointer(WebGLMacros.DVM_ATRIBUTE_TEXTURE0,
                               2, // 2 is for S,T co-ordinates in our texCoords array
                               gl.FLOAT,
                               false,0,0);
        gl.enableVertexAttribArray(WebGLMacros.DVM_ATRIBUTE_TEXTURE0);
        gl.bindBuffer(gl.ARRAY_BUFFER,null);
