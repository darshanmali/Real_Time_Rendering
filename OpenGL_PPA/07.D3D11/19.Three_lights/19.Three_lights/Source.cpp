...
float material_Diffuse[] = { 0.5f, 0.2f, 0.7f, 1.0f };
float material_Specular[] = { 0.7f, 0.7f, 0.7f, 1.0f };
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPreInstance, LPSTR lpszCmdLine, int iCmdShow)
{
    ...
    hwnd = CreateWindowEx(WS_EX_APPWINDOW,
        szClassname,
        TEXT("Darshan's : Direct X 3D sphere Albedo Lights...!"),
