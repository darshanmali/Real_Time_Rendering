...
//Pyramid Model Variables  

ID3D11Buffer* gpID3D11_Pyramid_Buffer_VertextBuffer_Position = NULL;
ID3D11Buffer* gpID3D11_Pyramid_Buffer_VertextBuffer_Color = NULL;
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPreInstance, LPSTR lpszCmdLine, int iCmdShow)
{
    ...
    hwnd = CreateWindowEx(WS_EX_APPWINDOW,
        szClassname,
        TEXT("Darshan's : Direct X 3D Pyramid and Cube Rotation...!"),
...
HRESULT Initialize()
{
    ...
    */
    ...
    hr = gpID3D11Device->CreateBuffer(&bufferDesc,
        NULL,
        &gpID3D11_Pyramid_Buffer_VertextBuffer_Position);
    ...
    gpID3D11DeviceContext->Map(gpID3D11_Pyramid_Buffer_VertextBuffer_Position,
        0,
    ...
    gpID3D11DeviceContext->Unmap(gpID3D11_Pyramid_Buffer_VertextBuffer_Position, 0);
    ...
    hr = gpID3D11Device->CreateBuffer(&bufferDesc,
        NULL,
        &gpID3D11_Pyramid_Buffer_VertextBuffer_Color);
    ...
    gpID3D11DeviceContext->Map(gpID3D11_Pyramid_Buffer_VertextBuffer_Color,
        0,
        D3D11_MAP_WRITE_DISCARD,
        0,
        &mappedSubresource);
    ...
    gpID3D11DeviceContext->Unmap(gpID3D11_Pyramid_Buffer_VertextBuffer_Color, 0);
...
void Display()
{
    ...
    rotation_matrix_y = XMMatrixRotationY(angle_Pyramid);
...
void unInitialize()
{
    ...
    if (gpID3D11_Pyramid_Buffer_VertextBuffer_Position)
    {
        gpID3D11_Pyramid_Buffer_VertextBuffer_Position->Release();
        gpID3D11_Pyramid_Buffer_VertextBuffer_Position = NULL;
    }

    if (gpID3D11_Pyramid_Buffer_VertextBuffer_Color)
    {
        gpID3D11_Pyramid_Buffer_VertextBuffer_Color->Release();
        gpID3D11_Pyramid_Buffer_VertextBuffer_Color= NULL;
    }
