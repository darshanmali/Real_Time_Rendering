...
ID3D11Buffer* gpID3D11Buffer_VertextBuffer_Position = NULL;
ID3D11Buffer* gpID3D11Buffer_VertextBuffer_Color = NULL;
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPreInstance, LPSTR lpszCmdLine, int iCmdShow)
{
    ...
    hwnd = CreateWindowEx(WS_EX_APPWINDOW,
        szClassname,
        TEXT("Darshan's : Direct3D11 Perspective Rectangle Multi-color ...!"),
...
HRESULT Initialize()
{
    ...
    hr = gpID3D11Device->CreateBuffer(&bufferDesc, 
        NULL, 
        &gpID3D11Buffer_VertextBuffer_Position);
    ...
    gpID3D11DeviceContext->Map(gpID3D11Buffer_VertextBuffer_Position,
        0,
    ...
    gpID3D11DeviceContext->Unmap(gpID3D11Buffer_VertextBuffer_Position, 0);
    ...
    hr = gpID3D11Device->CreateBuffer(&bufferDesc,
        NULL,
        &gpID3D11Buffer_VertextBuffer_Color);
    ...
    gpID3D11DeviceContext->Map(gpID3D11Buffer_VertextBuffer_Color,
        0,
        D3D11_MAP_WRITE_DISCARD,
        0,
        &mappedSubresource);
    ...
    gpID3D11DeviceContext->Unmap(gpID3D11Buffer_VertextBuffer_Color, 0);
...
void Display()
{
    ...
    XMMATRIX worldMatrix = XMMatrixTranslation(0.0, 0.0f, 3.0f);
...
void unInitialize()
{
    ...
    if (gpID3D11Buffer_VertextBuffer_Position)
    {
        gpID3D11Buffer_VertextBuffer_Position->Release();
        gpID3D11Buffer_VertextBuffer_Position = NULL;
    }
    if (gpID3D11Buffer_VertextBuffer_Color)
    {
        gpID3D11Buffer_VertextBuffer_Color->Release();
        gpID3D11Buffer_VertextBuffer_Color = NULL;
    }
