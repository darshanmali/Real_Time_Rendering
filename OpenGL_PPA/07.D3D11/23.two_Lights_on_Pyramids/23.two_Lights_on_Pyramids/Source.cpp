...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPreInstance, LPSTR lpszCmdLine, int iCmdShow)
{
    ...
    hwnd = CreateWindowEx(WS_EX_APPWINDOW,
        szClassname,
        TEXT("Darshan's : Direct X 3D Pyramid Lights...!"),
...
void Display()
{
    ...
    ModelMatrix = rotation_matrix_y * translation_matrix;
    ...
    if (gbLight == TRUE)
    {
        ...
        constantBuffer.Light_Position[0] = XMVectorSet(2.0f, 0.0f, 0.0f, 1.0f);
        ...
        constantBuffer.Light_Position[1] = XMVectorSet(-2.0f, 0.0f, 0.0f, 1.0f);
        
        constantBuffer.KA = XMVectorSet(0.5f, 0.5f, 0.5f, 0.5f);
        constantBuffer.KD = XMVectorSet(0.5f, 0.5f, 0.5f, 0.5f);
        constantBuffer.KS = XMVectorSet(0.5f, 0.5f, 0.5f, 0.5f);

        constantBuffer.shininess = 128.0f;
