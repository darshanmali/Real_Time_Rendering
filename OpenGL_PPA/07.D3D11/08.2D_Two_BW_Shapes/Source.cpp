...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPreInstance, LPSTR lpszCmdLine, int iCmdShow)
{
    ...
    hwnd = CreateWindowEx(WS_EX_APPWINDOW,
        szClassname,
        TEXT("Darshan's : Direct3D11 BW Triangle and Rectangle...!"),
...
HRESULT Initialize()
{
    ...
    hr = gpID3D11Device->CreateBuffer(&bufferDesc, 
        NULL, 
        &gpID3D11Buffer_VertextBuffer_Rectangle);
    if (FAILED(hr))
    {
        fopen_s(&gpFile_DM, gszLogFileName, "a+");
        fprintf_s(gpFile_DM, "ID3D11Device::CreateBuffer() Failed for Vertex Buffer. \n");
    ...
    gpID3D11DeviceContext->Map(gpID3D11Buffer_VertextBuffer_Rectangle,
        0,
        D3D11_MAP_WRITE_DISCARD,
        0,
        &mappedSubresource);
    ...
    gpID3D11DeviceContext->Unmap(gpID3D11Buffer_VertextBuffer_Rectangle, 0);
...
void Display()
{
    ...
    //translation is concerned with world matrix transformation
    worldMatrix = XMMatrixTranslation(1.5, 0.0f, 6.0f);
