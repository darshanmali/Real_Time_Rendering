...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer,OnGestureListener, OnDoubleTapListener{
	...
	private void initialize(GL10 gl)
	{
		...
		System.out.println("DVM : Inside the Initialize...!!! ");
		GLES32.glClearColor(0.0f,0.0f,1.0f, 1.0f);

		Matrix.setIdentityM(orthographicProjectionMatrix, 0);
		System.out.println("DVM : Before the Resize...!!! ");
	}
	...
	private void resize(int width, int height)
	{
		...
		System.out.println("DVM : Inside the Resize before orthoM ...!!! ");
		if(width <= height)
		{
		...
		System.out.println("DVM : Inside the Resize...!!! ");
	}
