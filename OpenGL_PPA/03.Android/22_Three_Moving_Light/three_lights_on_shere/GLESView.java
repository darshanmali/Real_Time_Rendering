...
package com.darshan_vilas_mali.three_lights_on_shere;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer,OnGestureListener, OnDoubleTapListener{
	...
	private int[] LA_Uniform_DM = new int[3];
	private int[] LD_Uniform_DM = new int[3];
	private int[] LS_Uniform_DM = new int[3];
	private int[] LPosition_Uniform_DM = new int[3];
	...
	private void initialize(GL10 gl)
	{
		...
		light[1].Light_D[1] = 1.0f;
		light[1].Light_D[2] = 0.0f;

		light[1].Light_S[0] = 0.0f;
		light[1].Light_S[1] = 1.0f;
		light[1].Light_S[2] = 0.0f;

		light[1].Light_P[0] = 0.0f;
		...
		light[2] = new Light();
		//LIGHT 2
		light[2].Light_A[0] = 0.0f;
		light[2].Light_A[1] = 0.0f;
		light[2].Light_A[2] = 0.0f;

		light[2].Light_D[0] = 0.0f;
		light[2].Light_D[1] = 0.0f;
		light[2].Light_D[2] = 1.0f;

		light[2].Light_S[0] = 0.0f;
		light[2].Light_S[1] = 0.0f;
		light[2].Light_S[2] = 1.0f;

		light[2].Light_P[0] = 0.0f;
		light[2].Light_P[1] = 0.0f;
		light[2].Light_P[2] = 0.0f;
		light[2].Light_P[3] = 1.0f;
		...
		LA_Uniform_DM[0] = GLES32.glGetUniformLocation( ShaderProgramObject_PV, "u_la[0]");
		LD_Uniform_DM[0] = GLES32.glGetUniformLocation( ShaderProgramObject_PV, "u_ld[0]");
		LS_Uniform_DM[0] = GLES32.glGetUniformLocation( ShaderProgramObject_PV, "u_ls[0]");
		LPosition_Uniform_DM[0] = GLES32.glGetUniformLocation( ShaderProgramObject_PV, "u_light_position[0]");

		LA_Uniform_DM[1] = GLES32.glGetUniformLocation( ShaderProgramObject_PV, "u_la[1]");
		LD_Uniform_DM[1] = GLES32.glGetUniformLocation( ShaderProgramObject_PV, "u_ld[1]");
		LS_Uniform_DM[1] = GLES32.glGetUniformLocation( ShaderProgramObject_PV, "u_ls[1]");
		LPosition_Uniform_DM[1] = GLES32.glGetUniformLocation( ShaderProgramObject_PV, "u_light_position[1]");

		LA_Uniform_DM[2] = GLES32.glGetUniformLocation( ShaderProgramObject_PF, "u_la[2]");
		LD_Uniform_DM[2] = GLES32.glGetUniformLocation( ShaderProgramObject_PF, "u_ld[2]");
		LS_Uniform_DM[2] = GLES32.glGetUniformLocation( ShaderProgramObject_PF, "u_ls[2]");
		LPosition_Uniform_DM[2] = GLES32.glGetUniformLocation( ShaderProgramObject_PF, "u_light_position[2]");
		...
		LA_Uniform_DM[0] = GLES32.glGetUniformLocation( ShaderProgramObject_PF, "u_la[0]");
		LD_Uniform_DM[0] = GLES32.glGetUniformLocation( ShaderProgramObject_PF, "u_ld[0]");
		LS_Uniform_DM[0] = GLES32.glGetUniformLocation( ShaderProgramObject_PF, "u_ls[0]");
		LPosition_Uniform_DM[0] = GLES32.glGetUniformLocation( ShaderProgramObject_PF, "u_light_position[0]");

		LA_Uniform_DM[1] = GLES32.glGetUniformLocation( ShaderProgramObject_PF, "u_la[1]");
		LD_Uniform_DM[1] = GLES32.glGetUniformLocation( ShaderProgramObject_PF, "u_ld[1]");
		LS_Uniform_DM[1] = GLES32.glGetUniformLocation( ShaderProgramObject_PF, "u_ls[1]");
		LPosition_Uniform_DM[1] = GLES32.glGetUniformLocation( ShaderProgramObject_PF, "u_light_position[1]");
		...
		KA_Uniform_DM[0] = GLES32.glGetUniformLocation( ShaderProgramObject_PF, "u_ka");
		KD_Uniform_DM[0] = GLES32.glGetUniformLocation( ShaderProgramObject_PF, "u_kd");
		KS_Uniform_DM[0] = GLES32.glGetUniformLocation( ShaderProgramObject_PF, "u_ks");
		Shininess_DM[0] = GLES32.glGetUniformLocation( ShaderProgramObject_PF, "u_shininess");
	...
	private void display()
	{
		...
		if(per_Vertex) {
			...
			if(bLight_sWitch)
			{
				...
				light[0].Light_P[0] = 0.0f;
				light[0].Light_P[1] = (float) (1.0f * math.sin(L_angle_1));
				light[0].Light_P[2] = (float) (1.0f * math.cos(L_angle_1));
				light[0].Light_P[3] = 1.0f;
				...
				light[1].Light_P[0] = (float) (1.0f * math.sin(L_angle_1));
				light[1].Light_P[1] = 0.0f;
				light[1].Light_P[2] = (float) (1.0f * math.cos(L_angle_1));
				light[1].Light_P[3] = 1.0f;
				GLES32.glUniform4fv(LPosition_Uniform_DM[1],1,light[1].Light_P, 0);

				GLES32.glUniform3fv(LA_Uniform_DM[2],1,light[2].Light_A, 0);
				GLES32.glUniform3fv(LD_Uniform_DM[2],1,light[2].Light_D, 0);
				GLES32.glUniform3fv(LS_Uniform_DM[2],1,light[2].Light_S, 0);
				light[2].Light_P[0] = (float) (1.0f * math.sin(L_angle_1));
				light[2].Light_P[1] = (float) (1.0f * math.cos(L_angle_1));
				light[2].Light_P[2] = 0.0f;
				light[2].Light_P[3] = 1.0f;
				GLES32.glUniform4fv(LPosition_Uniform_DM[2],1,light[2].Light_P, 0);
