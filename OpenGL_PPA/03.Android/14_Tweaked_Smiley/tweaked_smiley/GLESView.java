package com.darshan_vilas_mali.tweaked_smiley;
...
import com.darshan_vilas_mali.tweaked_smiley.GLESMacros;
import com.darshan_vilas_mali.tweaked_smiley.R;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer,OnGestureListener, OnDoubleTapListener{
	...
	private void initialize(GL10 gl)
	{
		...
		byteBuffer = ByteBuffer.allocateDirect(Float.BYTES * (4 * 2));
		byteBuffer.order(ByteOrder.nativeOrder());
		...
		kundali = loadGLTexture(R.raw.smiley);
	...
	private void display()
	{
		...
		final float[] quad_Texture = new float[8];
