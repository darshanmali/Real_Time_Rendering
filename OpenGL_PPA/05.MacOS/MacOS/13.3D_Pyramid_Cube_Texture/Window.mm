...
-(void)applicationDidFinishLaunching:(NSNotification *)aNotification
{
    ...
    defer:NO];
    [window setTitle: @"DVM: MacOS 2D Pyramid and Cube Texture."];
    [window center];
 ...
 @private
    ...
    -(void) prepareOpenGL
    {
       ...
       const GLfloat Cude_Vertices[] =
        ...
        glGenBuffers(1, &g_Pyramid_Color_Vbo_DM);
        glBindBuffer(GL_ARRAY_BUFFER, g_Pyramid_Color_Vbo_DM);
    ...
    -(void) drawView
    {
        ...
        mat4 RotaionMatrix_X = vmath::rotate(Q_angle, 1.0f, 0.0f, 0.0f);
        mat4 RotaionMatrix_Y = vmath::rotate(Q_angle, 0.0f, 1.0f, 0.0f);
        mat4 RotaionMatrix_Z = vmath::rotate(Q_angle, 0.0f, 0.0f, 1.0f);
        ...
        RotaionMatrix_X = vmath::rotate(T_angle, 0.0f, 1.0f, 0.0f);
    ...
    -(void)dealloc
    {
        ...
        if (g_Pyramid_Color_Vbo_DM)
        {
            glDeleteBuffers(1, &g_Pyramid_Color_Vbo_DM);
            g_Pyramid_Color_Vbo_DM = 0;
        }
